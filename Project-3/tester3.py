...
REQUIRED_DEFNS = [
                    "composite_ratio", 'vowels_count', 'wacky_factors', 'add_em_up'
                 ]
...
class AllTests (unittest.TestCase):
    ...
    '''composite_ratio() tests -- x1 pts each == 10 pts'''

    def test_composite_ratio_1(self):
        self.assertEqual(composite_ratio(625), 125.0)
    
    def test_composite_ratio_2(self):
        self.assertEqual(composite_ratio(128), 16.0)
    
    def test_composite_ratio_3(self):
        self.assertEqual(composite_ratio(17), 8.5)
    
    def test_composite_ratio_4(self):
        self.assertEqual(composite_ratio(8), 2.0)
    
    def test_composite_ratio_5(self):
        self.assertEqual(composite_ratio(31), 15.5)
    
    def test_composite_ratio_6(self):
        self.assertEqual(composite_ratio(77), 19.25)
    
    def test_composite_ratio_7(self):
        self.assertEqual(composite_ratio(5), 2.5)
    
    def test_composite_ratio_8(self):
        self.assertEqual(composite_ratio(144), 9.6)
    
    def test_composite_ratio_9(self):
        self.assertEqual(composite_ratio(139), 69.5)
    
    def test_composite_ratio_10(self):
        self.assertEqual(composite_ratio(629), 157.25)
    
    ############################################################################

    '''add_em_up() tests -- x1 pts each == 10 pts'''
    ...
    def test_add_em_up_10(self):
        self.assertEqual(add_em_up(22, 222222), 666)
    ...
    '''vowels_count() -- x1 pts each == 10 points'''

    def test_vowels_count_1(self):
        self.assertEqual(vowels_count(['a', 'e', 'e']), "Most Frequent: 'e' Count: 2")
    
    def test_vowels_count_2(self):
        self.assertEqual(vowels_count(['a', 'e', 'e','N', 'R', 'b', 'E', 'o', 'm','o', 's']), "Most Frequent: 'e' Count: 3")
    
    def test_vowels_count_3(self):
        self.assertEqual(vowels_count(['s', 'u', 'p','p', '@', 'm', 'm', 'Q', 'Y']), "Most Frequent: 'u' Count: 1")
    
    def test_vowels_count_4(self):
        self.assertEqual(vowels_count(['E']), "Most Frequent: 'e' Count: 1")
    
    def test_vowels_count_5(self):
        self.assertEqual(vowels_count(['u', 'a', 'e', 'U', 'o', 'u','U', 'u', 'I', 'O', 'U']), "Most Frequent: 'u' Count: 6")
    
    def test_vowels_count_6(self):
        self.assertEqual(vowels_count(['q', 'R', 's','T', 'u']), "Most Frequent: 'u' Count: 1")
    
    def test_vowels_count_7(self):
        self.assertEqual(vowels_count(['H', 'X', 'P','P', 'L', 'K', 'j', 't', 'r','b', 'z', 'e']), "Most Frequent: 'e' Count: 1")
    
    def test_vowels_count_8(self):
        self.assertEqual(vowels_count(['M', 'a', 'A', 's', 'o', 'n']), "Most Frequent: 'a' Count: 2")
    
    def test_vowels_count_9(self):
        self.assertEqual(vowels_count(['T', 'a', 'm', 'e', 'I', 'm', 'p', 'a', 'l', 'a']), "Most Frequent: 'a' Count: 3")
    
    def test_vowels_count_10(self):
        self.assertEqual(vowels_count(['R','A', 'D', 'I', 'O', 'H', 'E', 'A', 'D']), "Most Frequent: 'a' Count: 2")
	
	
	############################################################################

    '''wacky_factors() tests -- x1 pts each == 10 points'''

    def test_wacky_factors_1(self):
        self.assertEqual(wacky_factors([3, 5, 2], [55, 66, 99, 33, 22, 88]), 7)
    
    def test_wacky_factors_2(self):
        self.assertEqual(wacky_factors([1], [44,47,86,888,936,67, 55, 51, 53, 101]), 10)
    
    def test_wacky_factors_3(self):
        self.assertEqual(wacky_factors([4, 5], [440,50, 60, 70, 80, 100, 20, 45]), 13)
    
    def test_wacky_factors_4(self):
        self.assertEqual(wacky_factors([100], [55, 66, 99, 33, 22, 88]), 0)
    
    def test_wacky_factors_5(self):
        self.assertEqual(wacky_factors([33], [12, 23, 34, 45, 56, 66, 67, 78, 89, 99]), 2)
    
    def test_wacky_factors_6(self):
        self.assertEqual(wacky_factors([2, 4, 8, 16], [16, 32, 64, 128, 256, 512, 1024]), 28)
    
    def test_wacky_factors_7(self):
        self.assertEqual(wacky_factors([88, 99, 101], [146, 156, 4425, 5537, 202, 198]), 2)
    
    def test_wacky_factors_8(self):
        self.assertEqual(
            wacky_factors([2,3,4,6,12,],[60, 600, 600, 6000, 60000]), 25)
    
    def test_wacky_factors_9(self):
        self.assertEqual(wacky_factors(list(range(2,5)), list(range(1, 100))), 106)
    
    def test_wacky_factors_10(self):
        self.assertEqual(wacky_factors([2], range(2, 50, 2)), 24)

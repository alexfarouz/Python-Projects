...
class AllTests (unittest.TestCase):
    ...
    '''gas_price tests -- x1 pts each == 10 pts'''

    def test_gas_price_1(self):
        self.assertEqual(gas_price(4.31, 4.31), 'Full Tank')
    
    def test_gas_price_2(self):
        self.assertEqual(gas_price(3.73, 3.72), 'Full Tank')
        
    def test_gas_price_3(self):
        self.assertEqual(gas_price(100.0, 120.0), 'Half Tank')
        
    def test_gas_price_4(self):
        self.assertEqual(gas_price(100.0, 119.99), '3/4 Tank')
        
    def test_gas_price_5(self):
        self.assertEqual(gas_price(100.0, 180.0), '1/4 Tank')
        
    def test_gas_price_6(self):
        self.assertEqual(gas_price(100.0, 179.0), 'Half Tank')
        
    def test_gas_price_7(self):
        self.assertEqual(gas_price(100.0, 200.0), 'Go Home')
        
    def test_gas_price_8(self):
        self.assertEqual(gas_price(100.0, 210.0), 'Go Home')
    
    def test_gas_price_9(self):
        self.assertEqual(gas_price(8.5, 12.3), 'Half Tank')
    
    def test_gas_price_10(self):
        self.assertEqual(gas_price(50.0, 90.25), '1/4 Tank')
    

    ############################################################################

    '''level tests -- x1 pts each == 10 points'''

    def test_level_1(self):
        self.assertEqual(level(101, "Amateur"), 25)
    
    def test_level_2(self):
        self.assertEqual(level(100, "Beginner"), 25)
        
    def test_level_3(self):
        self.assertEqual(level(107, "Intermediate"), 17)
        
    def test_level_4(self):
        self.assertEqual(level(100, "Pro"), 16)
        
    def test_level_5(self):
        self.assertEqual(level(100, "Expert"), 12)
        
    def test_level_6(self):
        self.assertEqual(level(100, "Legendary"), 10)
        
    def test_level_7(self):
        self.assertEqual(level(30, "Expert"), 3)
        
    def test_level_8(self):
        self.assertEqual(level(0, "Amateur"), 0)
    
    def test_level_9(self):
        self.assertEqual(level(63, "Expert"), 7)
    
    def test_level_10(self):
        self.assertEqual(level(303, "Intermediate"), 50)
	
	
	############################################################################

    '''card_game tests -- x1 pts each == 20 points'''

    def test_card_game_1(self):
        self.assertEqual(card_game(12, 18, False), 'Player 1 Wins')
    
    def test_card_game_2(self):
        self.assertEqual(card_game(20, 8, True), 'Player 2 Wins')
        
    def test_card_game_3(self):
        self.assertEqual(card_game(39, 51, False), 'Player 1 Wins')
        
    def test_card_game_4(self):
        self.assertEqual(card_game(51, 39, True), 'Player 2 Wins')
        
    def test_card_game_5(self):
        self.assertEqual(card_game(10, 20, True), 'Player 1 Wins')
        
    def test_card_game_6(self):
        self.assertEqual(card_game(10, 20, False), 'Player 1 Wins')
        
    def test_card_game_7(self):
        self.assertEqual(card_game(36, 14, True), 'Player 1 Wins')
        
    def test_card_game_8(self):
        self.assertEqual(card_game(36, 14, False), 'Player 2 Wins')
        
    def test_card_game_9(self):
        self.assertEqual(card_game(23, 14, True), 'Player 1 Wins')
        
    def test_card_game_10(self):
        self.assertEqual(card_game(23, 14, False), 'Tie')
        
    def test_card_game_11(self):
        self.assertEqual(card_game(14, 27, True), 'Tie')
        
    def test_card_game_12(self):
        self.assertEqual(card_game(14, 27, False), 'Player 1 Wins')
        
    def test_card_game_13(self):
        self.assertEqual(card_game(27, 14, False), 'Player 2 Wins')
        
    def test_card_game_14(self):
        self.assertEqual(card_game(27, 14, True), 'Tie')
        
    def test_card_game_15(self):
        self.assertEqual(card_game(14, 23, True), 'Player 2 Wins')
        
    def test_card_game_16(self):
        self.assertEqual(card_game(14, 23, False), 'Tie')
        
    def test_card_game_17(self):
        self.assertEqual(card_game(7, 7, True), 'Tie')
        
    def test_card_game_18(self):
        self.assertEqual(card_game(7, 7, False), 'Tie')
        
    def test_card_game_19(self):
        self.assertEqual(card_game(51, 37, True), 'Player 1 Wins')
        
    def test_card_game_20(self):
        self.assertEqual(card_game(36, 51, True), 'Player 2 Wins')
